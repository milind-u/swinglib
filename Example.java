...
public final class Example {
  ...
  private static class Screen extends AbstractScreen {
    ...
    public Screen() {
      ...
      // Create a drop down box where they can select an option from the possible ages (child or
      // adult).
      ...
      newButton("Add person",
          new Bounds(fractionOfHeight(0.45), STD_BUTTON_WIDTH, STD_BUTTON_HEIGHT), this::add);
      ...
      table = newLabeledTable(Fonts.MEDIUM, Fonts.MEDIUM, "People",
          new Bounds(fractionOfHeight(0.65), fractionOfWidth(0.7), fractionOfHeight(0.3)), "Name",
          "Age").getSecond();
    }
